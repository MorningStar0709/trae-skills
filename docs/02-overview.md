...
**34 Skills + 8 Rules + Memory System** — transforms your AI Agent from "can do anything but unstable" to "fast when simple, rigorous when complex, always learning".
...
**Fully Compliant with Trae Official Specs**: Our 34 skills + 8 rules strictly follow Trae's frontmatter spec, SKILL.md contract template, and 250-character description limit. Can serve as a **best practice reference**.
...
**Skills Layer** — 34 "professional toolboxes" covering requirement clarification, design planning, code implementation, debugging, code review, commit management, branch completion, knowledge accumulation, browser debugging, accessibility auditing, data visualization, frontend design...
